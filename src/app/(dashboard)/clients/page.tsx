  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-sky-300">Client registry shell</p>
          <h2 className="mt-2 text-3xl font-bold tracking-tight">Clients</h2>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Client performance views will be connected to PostgreSQL-backed repositories after database and ingestion milestones.</CardDescription>
        </CardHeader>
        <CardContent>
          <EmptyState
