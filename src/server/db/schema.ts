...
export type RawIngestionRecordRow = typeof rawIngestionRecords.$inferSelect;
export type NewRawIngestionRecord = typeof rawIngestionRecords.$inferInsert;
export type DataAvailabilityRow = typeof dataAvailability.$inferSelect;
export type NewDataAvailability = typeof dataAvailability.$inferInsert;
export type BreakdownMetricDailyRow = typeof breakdownMetricDaily.$inferSelect;
export type NewBreakdownMetricDaily = typeof breakdownMetricDaily.$inferInsert;
export type MetricPeriodRow = typeof metricPeriod.$inferSelect;
export type NewMetricPeriod = typeof metricPeriod.$inferInsert;
export type CreativeMetadataRow = typeof creativeMetadata.$inferSelect;
export type NewCreativeMetadata = typeof creativeMetadata.$inferInsert;
